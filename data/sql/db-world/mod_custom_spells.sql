...
DELETE FROM `spell_script_names` WHERE `spell_id` IN (-26573, 900211);
...
-- SPELLMOD_JUMP_TARGETS, and running both paths double-hit every target.
-- The DELETE statements above still clear their bindings from live DBs.
